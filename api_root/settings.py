...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv("ENV_DB_NAME"),         # Nome do banco de dados
        'USER': os.getenv("ENV_DB_USER"),      # Usuário do banco
        'PASSWORD': os.getenv("ENV_DB_PASSWORD"),  # Senha do banco
        'HOST': os.getenv("ENV_DB_HOST"),             # Host onde o banco está rodando (use o IP ou domínio se for remoto)
        'PORT': os.getenv("ENV_DB_PORT")                # Porta do banco de dados (5432 é o padrão do PostgreSQL)
    }
}
